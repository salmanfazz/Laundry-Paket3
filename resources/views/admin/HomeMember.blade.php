...
@section('content')
	...
	<h1 class="mt-4">Data Pelanggan</h1>
		<a href="{{url ('admin/member/tambahPelanggan') }}" class="btn btn-success">Tambah</a>
		<br><br>
		<div id="container">
			<table id="datatable" class="table table-striped table-bordered autoWidth" cellspacing="0" width="100%">
				...
				<tbody>
					<tr>
						...
						<td colspan="2">
							<center>
							<a class = "btn btn-warning" href="{{url ('admin/member/editPelanggan/'.$row->id_member) }}">Edit</a>
							<a class = "btn btn-danger" href="{{url ('admin/delete/member'.$row->id_member) }}">Delete</a>
							</center>
						</td>
					</tr>
				</tbody>
