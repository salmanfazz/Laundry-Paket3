...
@section('content')
	...
	<h1 class="mt-4">Data Transaksi</h1>
		<a href="{{ url('admin/transaksi/tambahTransaksi') }}" class="btn btn-success">Tambah</a>
		<br><br>
		<div id="container">
			<table id="datatable" class="table table-striped table-bordered autoWidth" cellspacing="0" width="100%">
				...
				<tbody>
					<tr>
						...
						<td>
							<center><button class = "btn btn-danger" href="{{url('admin/delete/transaksi'.$row->id_transaksi)}}">Delete</button></center>
						</td>
					</tr>
				</tbody>
				@endforeach 
